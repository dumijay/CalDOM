...
//0.4.10 added siblings()
// 		Added window["CalDom"] without a version change
...
calDom.prototype = {
	    ...
	    try{
    		if(arguments.length == 2) {
				...
				if(typeof key == "object") {
					...
					return typeof this.elems[0][key] != 'undefined' ? this.elems[0][key] : this.elems[0].attributes[key].value;
				}
    		}
		}
		catch(e){
		...
		try{
    		if(arguments.length == 2) {
				...
				if(typeof key == "object") {
					...
					return this.elems[0].attributes[key].value;
				}
    		}
		}
		catch(e){
	...
	val: function(val){
	    if(typeof val == 'undefined') return this.elems[0].value;
...
window[selector] = function(query, parentWindow){
	return new calDom(query, parentWindow);
};

window["CalDom"] = function(query, parentWindow){
	return new calDom(query, parentWindow);
};
