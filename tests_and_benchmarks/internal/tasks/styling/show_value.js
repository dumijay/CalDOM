_pfreak.tasks.push({
    ...
    candidates: {
        "caldom": function(config){
            return config.caldomInstance.show("inline-block");
        }
    },
    ...
    assert: function(config, test_return){
        ...
        if( items[0].style.display != "inline-block" ) throw false;
        if( items[1].style.display != "inline-block" ) throw false;
    },
