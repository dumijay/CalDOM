_pfreak.tasks.push({
    ...
    short_name: "deleting_5_of_100_rows",

    category: "mixed_reactive",
    description: 'Deleting 5 rows of 100 rows with new data, each containing 1 text cell with a click event and a background color.',
    assert_delay: 1000,
    ...
    setTaskData: function(config){
        ...
        config.new_values.splice(10, 1);
        config.new_values.splice(20, 1);
        config.new_values.splice(30, 1);
        config.new_values.splice(40, 1);
        config.new_values.splice(50, 1);
    ...
    assert: function(config, test_return){
        ...
        if( tds.length != config.row_count - 5 ) throw false;
