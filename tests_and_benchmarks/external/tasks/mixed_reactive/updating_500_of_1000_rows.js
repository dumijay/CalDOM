_pfreak.tasks.push({
    ...
    short_name: "updating_500_of_1000_rows",

    category: "mixed_reactive",
    description: 'Updating 500 rows (even) of 1000 rows with new data, each containing 1 text cell with a click event and a background color.',
    assert_delay: 1000,
    ...
    setTaskData: function(config){
        ...
        for( var i = 0; i < config.row_count; i += 2 ){
            config.new_values[i] = getRandomValue(i, "B");
        }
