_pfreak.tasks.push({
    ...
    short_name: "deleting_50_of_100_rows",

    category: "mixed_reactive",
    description: 'Deleting 50 rows of 100 rows with new data, each containing 1 text cell with a click event and a background color.',
    assert_delay: 1000,
