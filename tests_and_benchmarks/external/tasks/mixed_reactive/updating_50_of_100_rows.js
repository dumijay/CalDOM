_pfreak.tasks.push({
    ...
    short_name: "updating_50_of_100_rows",

    category: "mixed_reactive",
    description: 'Updating 50 rows (even) of 100 rows with new data, each containing 1 text cell with a click event and a background color.',
    assert_delay: 1000,
