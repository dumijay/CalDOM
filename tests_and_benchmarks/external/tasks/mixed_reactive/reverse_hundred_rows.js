_pfreak.tasks.push({
    ...
    short_name: "reverse_hundred_rows",

    category: "mixed_reactive",
    description: 'Reversing 100 rows with new data, each containing 1 text cell with a click event and a background color. (10,000 repeats).',
    assert_delay: 1000,
