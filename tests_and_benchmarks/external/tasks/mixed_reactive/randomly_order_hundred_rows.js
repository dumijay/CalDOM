_pfreak.tasks.push({
    ...
    short_name: "randomly_order_hundred_rows",

    category: "mixed_reactive",
    description: 'Randomly ordering 100 rows with new data, each containing 1 text cell with a click event and a background color. (10,000 repeats).',
    assert_delay: 1000,
